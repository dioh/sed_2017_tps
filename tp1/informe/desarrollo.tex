Para desarrollar el traductor de \texttt{XMILE} a \texttt{DEVSML}, del cual se habló en las secciones anteriores, decidimos basarnos en 2 (dos) modelos clásicos implementados en \textit{System Dynamics}. 
