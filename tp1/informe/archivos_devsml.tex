...
\lstinputlisting[language=XML,caption={Archivo XSD de DEVSML para el modelo acoplado}, captionpos=b,showstringspaces=false,basicstyle=\small]{traductor/devsml.xsd}
