...
Para mayor legibilidad quitamos los valores del modelo "characteristictime" ya que este era constante y no aportaba al análisis.
...
\begin{figure}[!h]
    \centering     %%% not \center
        ...
        \caption{Modelo teacup - comparación de resultados}
\end{figure}
