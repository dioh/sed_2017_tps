...
fm_Susceptible_Succumbing::fm_Susceptible_Succumbing(const string &name) :
	Atomic(name),
...
Model &fm_Susceptible_Succumbing::initFunction()
{
...
Model &fm_Susceptible_Succumbing::externalFunction(const ExternalMessage &msg)
{
...
Model &fm_Susceptible_Succumbing::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &fm_Susceptible_Succumbing::outputFunction(const CollectMessage &msg)
{
