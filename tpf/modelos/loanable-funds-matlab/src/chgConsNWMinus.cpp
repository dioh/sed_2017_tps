...
chgConsNWMinus::chgConsNWMinus(const string &name) :
	Atomic(name),
...
Model &chgConsNWMinus::initFunction()
{
...
Model &chgConsNWMinus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgConsNWMinus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgConsNWMinus::outputFunction(const CollectMessage &msg)
{
