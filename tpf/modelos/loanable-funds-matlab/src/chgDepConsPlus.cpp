...
chgDepConsPlus::chgDepConsPlus(const string &name) :
	Atomic(name),
...
Model &chgDepConsPlus::initFunction()
{
...
Model &chgDepConsPlus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgDepConsPlus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgDepConsPlus::outputFunction(const CollectMessage &msg)
{
