...
chgDepInvMinus::chgDepInvMinus(const string &name) :
	Atomic(name),
...
Model &chgDepInvMinus::initFunction()
{
...
Model &chgDepInvMinus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgDepInvMinus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgDepInvMinus::outputFunction(const CollectMessage &msg)
{
