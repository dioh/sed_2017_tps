...
chgInvNWMinus::chgInvNWMinus(const string &name) :
	Atomic(name),
...
Model &chgInvNWMinus::initFunction()
{
...
Model &chgInvNWMinus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgInvNWMinus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgInvNWMinus::outputFunction(const CollectMessage &msg)
{
