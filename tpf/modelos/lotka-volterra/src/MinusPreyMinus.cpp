...
MinusPreyMinus::MinusPreyMinus(const string &name) :
	Atomic(name),
...
Model &MinusPreyMinus::initFunction()
{
...
Model &MinusPreyMinus::externalFunction(const ExternalMessage &msg)
{
...
Model &MinusPreyMinus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &MinusPreyMinus::outputFunction(const CollectMessage &msg)
{
