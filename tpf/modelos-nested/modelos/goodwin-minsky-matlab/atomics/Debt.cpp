...
VTime Debt::minposroot(double *coeff)
{
    float mpr;
    VTime ret;
...
double Debt::to_seconds(const VTime &vt)
{
...
Model &Debt::internalFunction(const InternalMessage &msg)
{
...
double Debt::get_param(const string &name)
{
    double value = 0;
