...
Totstock1DEVS_BASIC_COUPLED_stock1::Totstock1DEVS_BASIC_COUPLED_stock1(const string &name) :
	Atomic(name),
	in_plus_port_flow2_stock1(addInputPort("in_plus_port_flow2_stock1")),
	in_minus_port_flow1_stock1(addInputPort("in_minus_port_flow1_stock1")),
	in_minus_port_flow3_stock1(addInputPort("in_minus_port_flow3_stock1")),
	isSet_flow2_stock1(false),
	isSet_flow1_stock1(false),
	isSet_flow3_stock1(false),
...
Model &Totstock1DEVS_BASIC_COUPLED_stock1::externalFunction(const ExternalMessage &msg)
{
	...
	if(msg.port() == in_plus_port_flow2_stock1) {
		flow2_stock1 = x;
	...
	if(msg.port() == in_minus_port_flow3_stock1) {
		flow3_stock1 = x;
		isSet_flow3_stock1 = true;
	}
...
{
	double plus = 0;
	double minus = 0;if(isSet_flow2_stock1) { plus = plus + flow2_stock1; }if(isSet_flow1_stock1) { minus = minus + flow1_stock1; }if(isSet_flow3_stock1) { minus = minus + flow3_stock1; }double val = plus - minus;
