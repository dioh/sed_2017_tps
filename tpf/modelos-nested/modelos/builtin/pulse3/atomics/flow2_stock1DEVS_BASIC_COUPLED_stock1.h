...
class flow2_stock1DEVS_BASIC_COUPLED_stock1 : public Atomic {
  ...
  private:
    ...
    const Port &in_port_PULSE_V_volume_FP_firstPulse_I_interval_flow2;
    Port &out_port_flow2_stock1;
    
    double stock1;
    double PULSE_V_volume_FP_firstPulse_I_interval_flow2;
    bool isSet_stock1;
    bool isSet_PULSE_V_volume_FP_firstPulse_I_interval_flow2;
};
