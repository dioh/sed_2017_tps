...
chgWorkersNWPlus::chgWorkersNWPlus(const string &name) :
	Atomic(name),
...
Model &chgWorkersNWPlus::initFunction()
{
...
Model &chgWorkersNWPlus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgWorkersNWPlus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgWorkersNWPlus::outputFunction(const CollectMessage &msg)
{
