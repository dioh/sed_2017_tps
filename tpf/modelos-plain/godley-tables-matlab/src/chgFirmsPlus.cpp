...
chgFirmsPlus::chgFirmsPlus(const string &name) :
	Atomic(name),
...
Model &chgFirmsPlus::initFunction()
{
...
Model &chgFirmsPlus::externalFunction(const ExternalMessage &msg)
{
...
Model &chgFirmsPlus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &chgFirmsPlus::outputFunction(const CollectMessage &msg)
{
