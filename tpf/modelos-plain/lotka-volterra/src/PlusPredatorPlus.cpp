...
PlusPredatorPlus::PlusPredatorPlus(const string &name) :
	Atomic(name),
...
Model &PlusPredatorPlus::initFunction()
{
...
Model &PlusPredatorPlus::externalFunction(const ExternalMessage &msg)
{
...
Model &PlusPredatorPlus::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &PlusPredatorPlus::outputFunction(const CollectMessage &msg)
{
