...
FminusInfectiousRecovering::FminusInfectiousRecovering(const string &name) :
	Atomic(name),
...
Model &FminusInfectiousRecovering::initFunction()
{
...
Model &FminusInfectiousRecovering::externalFunction(const ExternalMessage &msg)
{
...
Model &FminusInfectiousRecovering::internalFunction(const InternalMessage &)
{
	passivate();
	return *this ;
}
...
Model &FminusInfectiousRecovering::outputFunction(const CollectMessage &msg)
{
